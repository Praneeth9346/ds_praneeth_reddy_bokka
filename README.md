...
1.  **Datasets**:
     ...
     -2.Greed & Fear Index: `https://drive.google.com/file/d/1PgQC0tO8XN-wqkNyghWc_-mnrYv_nhSf/view?usp=sharing`


    Download these datasets and move them to the required paths.
    
3.  **Open the Notebook**: Launch `notebook_1.ipynb` in Jupyter Notebook or Google Colab.
4.  **Dependencies**: Install following Python libraries :
    ```bash
    pip install pandas matplotlib seaborn
    ```
5.  **Execution**: Run all cells in the notebook.
